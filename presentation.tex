...
\newcommand{\fig}[2]{
    \begin{figure}\begin{center}\includegraphics[width=0.8\textwidth,height=0.8\textheight,keepaspectratio=true]{figures/#1}\caption{#2\label{#1}}\end{center}
    \end{figure}}
...
\begin{frame}{Equality in mathematics}
