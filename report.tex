...
multiple equalities may be possible and this unsatisfactory. An h-set should only be equal to 
...
there may be multiple proofs identity, the \keyword{uniqueness of identity proofs 
...
A base category is chosen such that it possesses the properties that are required  for the contexts in the particular type theory that is being modelled. With this 
...
In a presheaf model over a base category $\mathcal{C}$, take the category of 
...
original graph $\Gamma$, see \cref{depgraphdiag}. Between the original graph and 
...
remember from \cref{simpmod} that the goal is to find a constructive model in category theory that allows 
