...
\caption{An illustration of the free bounded distributive lattice over generating sets of dimension variables $I=\emptyset$,$I=\{x\}$, $I=\{x,y\}$ and $I=\{x,y,z\}$ by writing edges $a \rightarrow b$ if and only if $a \leq b$. This lattice gives rise to a De Morgan algebra $dM(I)$ by defining $\wedge$ as the infinum (the smalles element) of the lattice and $\vee$ as the supremum (the largest element) of the lattice. Illustration taken from \cite{Eppstein2010}.}
\end{figure}
