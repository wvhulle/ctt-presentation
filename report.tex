...
means that an arbitrary pre-sheaf model is not sufficient any more to model univalent type theory. 
To find a pre-sheaf model for univalent type theory, it is 
necessary to look further into variations on the pre-sheaf model explained 
above.  
...
in this model does not get stuck and can always be simplified or computed into an expression using the primitives of the model. Proof of concept is the recent implementation of 
...
category $\cube$ to the same set containing one element $\singleton$. 
