...
set model and cubical type theory (see \Cref{cubical}) which is an extension of univalent type theory. With the help of the \texttt{Glue} construction that is part of the cubical set model (see \Cref{glueOp}), it is possible to proof the univalence axiom in cubical type theory. This was discussed in \Cref{univalenceproof}. The application of the 
